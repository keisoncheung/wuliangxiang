...
<body topmargin="0">
    <form id="uploadFace" runat="server">
        ...
        <input language="javascript" onclick="javascript:newImages()" type="button" value='<%=ResourceManager.GetString("insertimage")%>' id="insertImg" /><br />
                        ...
                        </asp:RadioButtonList><div style=" display:none">[ <%=ResourceManager.GetString("uploaduse")%>：<asp:label ID="useSpace" ForeColor="Red" runat=server />，<%=ResourceManager.GetString("have")%>：<asp:label ID="space" ForeColor="Red" runat=server /><%=ResourceManager.GetString("singlesize")%>：
    ]</div>[单个文件限制：<asp:Label ID="maxSingleUploadSize" runat="server" ForeColor="Red"></asp:Label>]</fieldset>
...
<HeaderStyle Font-Bold="True" ForeColor="WindowText" BackColor="Control" BorderWidth="1px" HorizontalAlign="Center" />
                ...
                <fieldset><legend><span style="color: dimgray"><span style="color: gray"><%=ResourceManager.GetString("imagepreview")%></span>&nbsp;</span></legend>
                    <table height="100%" width="100%">
                        <tr>
                            <td colspan="3" rowspan="3" style="height: 210px">
                                <div style="border-right: 1.5pt inset; padding-right: 0px; border-top: 1.5pt inset;
                                    ...
                                    border-left: 1.5pt inset; width: 380px; padding-top: 2px; border-bottom: 1.5pt inset;
                                    height: 210px; background-color: white">
                                    <div id="previewImg" align="center" style="background-color: white">
                                    </div>
                                </div></td>
                            <td colspan="1" rowspan="3" valign="top" style="height: 210px"><%=ResourceManager.GetString("width")%>：<input id="ImgWidth" style="width: 97px" onblur="if(document.getElementById('checkimgsize').checked){checksize(this.value,'wedth');}" type="text" maxlength="10" /><br />
                                <br />
                                <%=ResourceManager.GetString("height")%>：<input id="ImgHeight" style="width: 97px" type="text" onblur="if(document.getElementById('checkimgsize').checked){checksize(this.value,'height');}" maxlength="10" /><br /><br /><input id="checkimgsize" type="checkbox" checked="CHECKED" />&nbsp;<%=ResourceManager.GetString("keepratio")%><br /><br />
                                ...
                                <span style="display:none;"><%=ResourceManager.GetString("watermark")%><input id="watermark" onclick="changeWaterMark('watermark')" type="checkbox" />
                                ...
                                <a href="#" onclick="if(is_ie){showModalDialog('Advanced.aspx',window,'dialogWidth:800px;dialogHeight:600px;status:0;scroll:yes');reload.click();}else{window.open('Advanced.aspx');}">
                                <%=ResourceManager.GetString("advancedsetting")%></a><a id='reload' href='uploadimg.aspx' style='display:none'></a></span></td>
                        </tr>
                    </table>
                </fieldset>
