...
<!--#include file="daohang.aspx" -->
    ...
    <fieldset  style="width:758px; font-size:12px;">
        ...
        <a href="yingyong.aspx" style='display:block; float:left; margin-right:20px; color:Red;'>添加案例</a>
        </div>
        </fieldset>
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="链接地址">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Eval("ClassPath") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("ClassPath") %>'></asp:Label>
                    </ItemTemplate>
