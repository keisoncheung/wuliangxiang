...
public partial class manager_tuiguangadd : System.Web.UI.Page
{
    ...
    protected void Submit1_ServerClick(object sender, EventArgs e)
    {
        ...
        if (bpic.Length > 1)
        {
            ...
            if (Request["id"] != null)
            {
                ...
                if (Igs(sql))
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改成功！\");location.href=\"./tuiguangshow.aspx\";</script>");
                }
                else
                {
            ...
            else
            {
                ...
                if (Igs(sql))
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料添加成功！\");location.href=\"./tuiguangshow.aspx\";</script>");
                }
                else
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改失败！\");</script>");
        ...
        else
        {
            ...
            {
                sql = "insert into links(title,linkurl,Picture,CreateDate,languageId,parid) values('" + txttit.Text + "','" + txtweb.Text + "','nopic.gif ','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "',1)";
