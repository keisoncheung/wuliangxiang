<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mainpiclist.aspx.cs" Inherits="manager_mainpiclist" %>
    ...
    <div id="DIV1">    
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="mainpic.aspx?id={0}&amp;ac=产品管理">
                 <ItemStyle   HorizontalAlign="Center"  Width=10% />
