<%@ Page Language="C#" AutoEventWireup="true" CodeFile="toppicsshow.aspx.cs" Inherits="manager_toppicsshow" %>
...
<!--#include file="daohang.aspx" -->
    ...
    <div><a href="toppics.aspx" style='display:block; float:left; margin-right:20px; color:Red;'>添加图片</a></div>
   
        
        <div style=" margin:10px 0px 10px 20px;">
        
            <asp:DropDownList ID="lanmuxz" runat="server" Width="192px" AutoPostBack="true" 
                onselectedindexchanged="lanmuxz_SelectedIndexChanged" Visible="false">
                <asp:ListItem Value="-1">--请选择--</asp:ListItem>
                            <asp:ListItem Value="2">关于我们</asp:ListItem>
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="toppics.aspx?id={0}&amp;ac=产品应用">
