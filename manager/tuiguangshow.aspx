<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tuiguangshow.aspx.cs" Inherits="manager_tuiguangshow" %>
...
<!--#include file="daohang.aspx" -->
    ...
    <div id="DIV1" style="width:758px; margin:0 auto; font-size:12px;">    
    
    <fieldset  style="width:758px; font-size:12px; display:none;">
        <legend>类别</legend>
        <div style=" margin:10px 0px 10px 20px; display:none;">
        <%=stypename()%><a href='friendsadd.aspx' id="ret" style='display:block; float:left; margin-right:20px; color:Red;' runat=server>返回</a>
        </div>
        </fieldset>
        <asp:Button ID="Button1" runat="server" Text="添加链接" Width="100px" 
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <ItemTemplate>
                        <asp:Label ID="txtmc" runat="server"  Text='<%# DataBinder.Eval(Container, "DataItem.Title") %>' ></asp:Label>
                    </ItemTemplate>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="tuiguangadd.aspx?id={0}&amp;ac=产品应用">
