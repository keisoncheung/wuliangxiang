...
public partial class manager_tuiguangshow : System.Web.UI.Page
{
    ...
    public string stypename()
    {
        ...
        foreach (DataRow dr in dt.Select())
        {
            sbr.Append(" <a href='tuiguangshow.aspx?lan=" + dr["id"] + "' style='display:block; float:left; margin:0px 20px 10px 0px;'>" + dr["ClsName"] + "</a>");
        }
        ret.Visible = false;
        tabcont.Visible = true;
        //}
    ...
    {
        Response.Redirect("tuiguangadd.aspx");
    }
}
