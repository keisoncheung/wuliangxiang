...
namespace DLL
{
    public class OleDbHelper
    {
        ...
        //数据库连接字符串
        public static string Conn { get { return "Provider = Microsoft.Jet.OLEDB.4.0; Data Source = " + HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["AccessConnectionString"]); } }
        public static string Conn2 { get { return "Provider = Microsoft.Jet.OLEDB.4.0; Data Source = " + HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["AccessConnectionString2"]); } }
        // 用于缓存参数的HASH表
